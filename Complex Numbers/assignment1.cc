...
int main(void)
{
    ...
    c = a;
    c /= b;
    cout << "c /= b = " << c << endl<<endl;

    cout<<"Complex Conjugate"<< endl;
    cout<<"a = " << a << endl;
    cout<< "The Conjugate of a is: " <<a.conjugate()<<endl;
    cout<< "b = " << b << endl;
    cout << "The Conjugate of b is: " <<b.conjugate() <<endl << endl;

    cout<<"Complex Multiplicative Inverse"<< endl;
    cout<<"a = " << a << endl;
    cout<< "The Inverse of a is: " <<a.inverse()<<endl;
    cout<< "b =" << b << endl;
    cout << "The Inverse of b is: " <<b.inverse() <<endl<<endl;

    cout<<"Complex Magnitude"<< endl;
    cout<<"a = " << a << endl;
    cout<< "The Magnitude of a is: " <<a.magnitude()<<endl;
    cout<< "b = " << b << endl;
    cout << "The Magnitude of b is: " <<b.magnitude() <<endl << endl;
